...
public class RobotMap {
  ...
  private static final int LowerWheelLeft = 5;
  private static final int LowerWheelRight = 6;
  private static final int RaiseFront = 7;
  private static final int RaiseBack = 8;
